...
import { MdGpsFixed, MdInfo, Md3DRotation, MdMap, MdMyLocation, MdNavigation, MdCheck, MdClose } from 'react-icons/md';

const MapCard3D = (props) => {
  const { ...rest } = props;
  ...
  // Helper function for pointer position calculation
  ...
  }, [is3DView]); // Only re-run if is3DView changes
    ...
    >
      <Box position="relative" width="100%" height="100%" minHeight="600px">
        ...
        >
          ...
          >
            <Icon 
              as={is3DView ? MdMap : Md3DRotation}
        ...
        {showInfo && (
          ...
          >
            ...
            <Flex direction="column" gap={2}>
              ...
              <Flex justify="space-between">
                <Text color={textColorSecondary}>View Mode: </Text>
                <Text fontWeight="medium">{is3DView ? "3D" : "2D"}</Text>
              </Flex>
            </Flex>
          </Box>
        )}
